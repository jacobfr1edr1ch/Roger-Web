...
/* harmony import */ var _notyf__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./notyf */ "./source/_assets/js/notyf.js");
...
var fakeSend = function fakeSend() {
  return new Promise(function (resolve) {
    return setTimeout(resolve, 2000);
  });
};

var send = function send(form) {
  return fetch(form.action, {
    ...
    body: JSON.stringify(Object.values(form.elements).slice(0, -1).reduce(function (acc, input) {
      return _objectSpread(_objectSpread({}, acc), {}, _defineProperty({}, input.name, input.value));
    }, {}))
  }).then(function (response) {
    return response.status === 200 ? response : Promise.reject({
      response: response
    });
  });
};
...
if (contactForm) {
  contactForm.onsubmit = function (e) {
    ...
    fakeSend(contactForm).then(function (response) {
      _notyf__WEBPACK_IMPORTED_MODULE_0__.default.success('Your message has been sent.');
      contactForm.reset();
    })["catch"](function (error) {
      _notyf__WEBPACK_IMPORTED_MODULE_0__.default.error('Sending failed, try again later.');
...
highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().registerLanguage('xml', __webpack_require__(/*! highlight.js/lib/languages/xml */ "./node_modules/highlight.js/lib/languages/xml.js"));
...
highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().registerLanguage('php-template', __webpack_require__(/*! highlight.js/lib/languages/php-template */ "./node_modules/highlight.js/lib/languages/php-template.js"));
highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().registerLanguage('apache', __webpack_require__(/*! highlight.js/lib/languages/apache */ "./node_modules/highlight.js/lib/languages/apache.js"));
...
highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().registerLanguage('shell', __webpack_require__(/*! highlight.js/lib/languages/shell */ "./node_modules/highlight.js/lib/languages/shell.js"));
highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAll();
...
/* harmony import */ var _highlight__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./highlight */ "./source/_assets/js/highlight.js");
/* harmony import */ var _contact__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./contact */ "./source/_assets/js/contact.js");
